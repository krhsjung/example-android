...
object OAuthHelper {
     ...
     * OAuth 인증 URL 생성
     *
     * @param provider 소셜 제공자 (Google, Apple 등)
     * @return OAuth 인증 페이지 URL
     */
    fun getOAuthUrl(provider: LoginProvider): String {
     ...
     */
    fun launchOAuth(context: Context, provider: LoginProvider) {
